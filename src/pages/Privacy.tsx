  ...
  return (
    <div className="container mx-auto px-4 py-24">
      <Card className="max-w-4xl mx-auto p-6 md:p-8 prose prose-gray dark:prose-invert prose-headings:text-foreground prose-p:text-muted-foreground">
        <h1 className="text-3xl font-bold mb-6">Privacy Statement AI Automation B.V.</h1>
        <p className="text-sm text-muted-foreground mb-6">Version: 1.0<br />Date: January 11, 2025</p>

        <p>Welcome to the website of AI Automation B.V. ("AI Automation" or "we"). AI Automation respects your privacy and ensures that the personal information you provide to us is treated confidentially. In this privacy statement, we explain which data we collect, for what purposes we use this data, and what rights you have.</p>

        <h2>1. Applicability</h2>
        <p>This privacy statement applies to all processing of personal data that takes place via our website http://ai-automation.nl/ (hereinafter: the "Website") and the services we offer. By visiting the Website and/or using our services, you agree to the contents of this privacy statement.</p>

        <h2>2. Who is responsible for processing your data?</h2>
        <p>The party responsible for processing your personal data is:<br />AI Automation B.V.</p>
        <p>If you have any questions about this privacy statement, you can contact us via the email address [info@ai-automation.nl] (if applicable) or through the contact form on the Website.</p>
        ...
        <p>We use this information to improve the functionality and performance of the Website. We do not directly link this data to your name, email address, or other personal information you have provided via forms.</p>

        <h2>4. Purposes and legal grounds for processing</h2>
        ...
        <p>Website analysis and maintenance</p>
        <ul>
        ...
        <p>We do not retain your personal data any longer than necessary for the purpose for which we collected it, unless we are legally required to retain your data for a longer period.</p>
        <ul>
        ...
        <p>AI Automation does not sell your personal data to third parties. We only share your personal data in the following cases:</p>
        <ul>
        ...
        <h2>7. Cookies</h2>
        <p>Our Website may use functional, analytical, and possibly tracking cookies. A cookie is a small text file that is stored on your device when you visit a website.</p>
        <ul>
        ...
        <p>Would you like more information about which cookies we use, how long they are stored, and how to change your settings? Please contact us via our contact form or refer to the (possible) Cookie Statement on the Website. You can also delete or disable cookies at any time via your browser settings.</p>

        <h2>8. Security</h2>
        <p>We take appropriate technical and organizational measures to protect your personal data against loss or unlawful use. Think of using secure connections (SSL certificates), encryption, and access controls.</p>
        ...
        <p>To exercise your rights, you can contact us via the contact form on our Website or (optionally) via [info@ai-automation.nl]. We will respond within one month of your request, unless the complexity of the request or the number of requests justifies a longer period. If the timeframe is extended, we will inform you accordingly.</p>

        <h2>10. Complaints</h2>
        <p>If you have a complaint about the processing of your personal data by AI Automation, we recommend that you first contact us via the contact form on our Website (or via [info@ai-automation.nl]). If we are unable to resolve the issue together, you can also submit a complaint to the Dutch Data Protection Authority (Autoriteit Persoonsgegevens) via www.autoriteitpersoonsgegevens.nl.</p>

        <h2>11. Changes</h2>
        <p>AI Automation may update this privacy statement from time to time, for example if we make changes to the Website or if there are changes in laws and regulations. The most recent version of the privacy statement will always be published on the Website. We recommend that you check this privacy statement regularly.</p>

        <p>If you have any questions, comments, or requests regarding this privacy statement or the processing of your personal data, please contact us via the contact form on the Website or (if applicable) via [info@ai-automation.nl].</p>
